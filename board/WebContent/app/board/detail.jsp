...
<html>
   <head>
      ...
      <style>
         ...
         div.delete-button, div.cancel-button {
   ...
   <body class="is-preload">
               ...
               <div class="wrapper">
                  <div class="inner">
                     ...
                     <section class="main accent2" style="padding:3%">
                        ...
                        <form method="post" action="#" name="uploadForm" class="combined" style="width:auto;">
                           ...
                           <input id="register" type="submit" class="primary" value="등록" onclick="upload()"/>
                        </form>
      ...
      <!-- Scripts -->
         <script>
         	...
         	//세션에서 값을 가져옴    ---> ajax에 3개 다 넘겨서 간단하게 사용할 수 있음
